...
const port = por.PORT;
const ownerNumber = ["94702981539" "94726462447" ];
if (!app) return;
// Session directory
...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("SPECTOR-KING~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 KING SPECTOR is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© KING SPECTOR 𝗑ᴾᴿᴼ 💚 Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to © KING SPECTOR 𝗑ᴾᴿᴼ 💚!** 🎉 
          ...
          --- Thank you for using **© KING SPECTOR  𝗑ᴾᴿᴼ 💚**. 
      ...
      conn.sendMessage(conn.user.id, {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: "© KING SPECTOR 𝗑ᴾᴿᴼ 💚",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© KING SPECTOR𝚄 𝗑ᴾᴿᴼ 💚",
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, KING_SPECTOR Is started✅");
});
app.listen(port, () =>
